...
using Owin;
using Sistema.API.Segurança;
using Sistema.Negocio.UsuarioNegocio;
using Sistema.WebAPI.IOC;
using System;
using System.Threading.Tasks;
using System.Web.Configuration;
using System.Web.Http;

[assembly: OwinStartup(typeof(Sistema.API.Startup))]
    ...
    public class Startup
    {
        ...
        public void ConfigureOAuth(IAppBuilder app)
        {
            ...
            OAuthAuthorizationServerOptions OAuthServerOptions = new OAuthAuthorizationServerOptions()
            {
                ...
                TokenEndpointPath = new PathString("/api/security/token"), //Especifico onde fazer a requisicao para obter um token
